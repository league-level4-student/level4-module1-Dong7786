...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "If you don't know how to play snake, Google it";
	...
	private void gameOver() {
		...
		int	again = JOptionPane.showConfirmDialog(null, "Would you like to try again?");
